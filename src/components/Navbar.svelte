  ...
  <div class="navigation bg-gray-50 pl-12 py-5 rounded-xl h-20">
    <ul class="flex flex-row items-center justify-center gap-12 relative">
      <li class="active" on:click={()=>{selectedStore.set("Home")}}>
        <a 
          class="flex flex-col items-center justify-center ease-in-out duration-600 group focus:outline-none "
          href="#!">
          <div class="icon w-10 h-10 leading-8 transition duration-[400ms] ease-in ring-gray-800 rounded-full">
      ...
      <li class="active" on:click={()=>{selectedStore.set("Explore")}}>
        <a 
          class="flex flex-col items-center justify-center ease-in-out duration-600 group focus:outline-none "
          href="#!">
          <div class="icon w-10 h-10 leading-8 transition duration-[400ms] ease-in ring-gray-800 rounded-full">
      ...
      <li class="active" on:click={()=>{selectedStore.set("Chat")}}>
        <a 
          class="flex flex-col items-center justify-center ease-in-out duration-600 group focus:outline-none "
          href="#!">
          <div class="icon w-10 h-10 leading-8 transition duration-[400ms] ease-in ring-gray-800 rounded-full">
            <svg xmlns="http://www.w3.org/2000/svg" style={$selectedStore=='Chat'?'fill:#3868A8;':'fill:#a0aec0;'} width="40" height="40" class="ease-in" viewBox="0 0 16 16"> <path d="M14 1a1 1 0 0 1 1 1v8a1 1 0 0 1-1 1H4.414A2 2 0 0 0 3 11.586l-2 2V2a1 1 0 0 1 1-1h12zM2 0a2 2 0 0 0-2 2v12.793a.5.5 0 0 0 .854.353l2.853-2.853A1 1 0 0 1 4.414 12H14a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2H2z"/> <path d="M3 3.5a.5.5 0 0 1 .5-.5h9a.5.5 0 0 1 0 1h-9a.5.5 0 0 1-.5-.5zM3 6a.5.5 0 0 1 .5-.5h9a.5.5 0 0 1 0 1h-9A.5.5 0 0 1 3 6zm0 2.5a.5.5 0 0 1 .5-.5h5a.5.5 0 0 1 0 1h-5a.5.5 0 0 1-.5-.5z"/> </svg></div>
          <span class="text-center text absolute text-gray-800 font-semibold text-sm translate-y-6 transition duration-[400ms] ease-in opacity-0">
            Messaging
          </span>
        </a>
      </li>
      <li class="active" on:click={()=>{selectedStore.set("Profile")}}>
        <a 
          class="flex flex-col items-center justify-center ease-in-out duration-600 group focus:outline-none "
          href="#!">
          <div class="icon w-10 h-10 leading-8 transition duration-[400ms] ease-in ring-gray-800 rounded-full">
